...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.trainingPlanButton.setStyleSheet("font:16pt;background:rgb(93, 193, 255)")
        ...
        self.addButton.setGeometry(QtCore.QRect(940, 25, 150, 40))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "计划时间"))
...
class trainingProgram(QtWidgets.QMainWindow, Ui_Form):  # 基本功能动作训练
    def __init__(self):
        super(trainingProgram, self).__init__()
        self.setupUi(self)
    ...
    def addButtonClick(self, *args):  # 新增训练计划，页面已经完成了
