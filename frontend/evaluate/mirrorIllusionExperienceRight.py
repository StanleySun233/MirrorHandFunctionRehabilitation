...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.PictureLabel.setPixmap(QPixmap('D:\Pycharm\留存\mirrorLeft.jpg'))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_23.setText(_translate("MainWindow", "注：以右侧肢体（患侧）为例，左侧为主动侧"))
        self.label_5.setText(_translate("MainWindow", "1.我觉得镜子里看到的自己右侧肢体（右手）很自然，不像是别人的(得分:"))
        self.label_6.setText(_translate("MainWindow", "评定日期:"))
        self.label_7.setText(_translate("MainWindow", ")"))
        self.label_8.setText(_translate("MainWindow", ")"))
        self.label_9.setText(_translate("MainWindow", "2.我觉得镜子里看到的右侧肢体（右手）和镜子后面的肢体是重合的(得分:"))
        self.label_10.setText(_translate("MainWindow", "3.我觉得镜子里看到的右侧肢体就是我的右侧肢体(得分:"))
        self.label_11.setText(_translate("MainWindow", ")"))
        self.label_12.setText(_translate("MainWindow", "4.我觉得镜子里的右侧肢体（右手）是自己身体的一部分(得分:"))
        self.label_13.setText(_translate("MainWindow", ")"))
        self.label_14.setText(_translate("MainWindow", "5.我觉得自己的右侧肢体（右手）也能跟着镜子里的右手动起来(得分:"))
        self.label_15.setText(_translate("MainWindow", ")"))
        self.label_16.setText(_translate("MainWindow", "6.我可以控制镜子里左侧肢体（右手）的运动(得分:"))
        self.label_17.setText(_translate("MainWindow", ")"))
        self.label_18.setText(_translate("MainWindow", "7.我无法分辨我的右手在哪里了(得分:"))
        self.label_19.setText(_translate("MainWindow", ")"))
        self.label_20.setText(_translate("MainWindow", "8.我感觉我的右侧肢体有些不寻常(得分:"))
...
class  mirrorIllusionExperienceRight(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self,patient_id):
        super( mirrorIllusionExperienceRight, self).__init__()
        self.setupUi(self)
...
if __name__ == '__main__':
    ...
    gui = mirrorIllusionExperienceRight()
    gui.show()
    sys.exit(app.exec_())