...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionTypeComboBox.addItems(['','浅感觉','深感觉','复合感觉'])
        ...
        self.label_4.setGeometry(QtCore.QRect(10, 280, 800, 40))
        self.label_4.setStyleSheet("font:14pt;color:red")

        self.actionVedioButton = QtWidgets.QPushButton(self.centralwidget)
        self.actionVedioButton.setGeometry(QtCore.QRect(10, 360, 250, 50))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "感觉运动训练上传页面"))
        ...
        self.label_4.setText(_translate("MainWindow", "备注:浅感觉序号：1-13;深感觉序号：1-3;复合感觉序号:1-14"))
...
class SensorimotorUpLoad(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        super(SensorimotorUpLoad, self).__init__()
        self.setupUi(self)
