...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionTypeComboBox.addItems(['', '拇指运动', '精细灵活性运动', '抓握运动', '手指动作', '腕部运动', '前臂旋转'])
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "基本动作训练上传页面"))
        ...
        self.label_4.setText(
            _translate("MainWindow", "备注:拇指运动序号：1-8;精细灵活性运动序号：1-3;抓握运动序号:1-5;手指动作序号：1-6；腕部运动序号：1-5；前臂旋转序号：1-3"))
...
class basicUpLoad(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        super(basicUpLoad, self).__init__()
        self.setupUi(self)
